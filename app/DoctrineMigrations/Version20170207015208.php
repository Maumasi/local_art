 ...
 */
class Version20170207015208 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE artist ADD email VARCHAR(255) NOT NULL, ADD website VARCHAR(255) DEFAULT NULL, CHANGE bio bio LONGTEXT DEFAULT NULL, CHANGE business_name business_name VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE artist ADD CONSTRAINT FK_1599687A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_1599687E7927C74 ON artist (email)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP INDEX UNIQ_1599687E7927C74 ON artist');
        $this->addSql('ALTER TABLE artist DROP email, DROP website, CHANGE bio bio LONGTEXT NOT NULL COLLATE utf8_unicode_ci, CHANGE business_name business_name VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci');
    }
}
